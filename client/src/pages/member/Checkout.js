...
import { FaUser, FaCreditCard, FaTruck, FaShieldAlt } from 'react-icons/fa';
import path from 'utils/path';
import withBase from 'hocs/withBase';
import { apiVnpayPayment } from 'api/payment';
...
const Checkout = ({ dispatch }) => {
  ...
  const handlePlaceOrder = async () => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URI}/payment/create_payment_url`, {
        method: 'POST',
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-red-700 to-red-900 text-white">
          <div className="w-full mx-auto py-10 px-4 flex flex-col justify-center items-center">
            <h1 className="font-bold uppercase text-3xl md:text-4xl font-main2 mb-2">Checkout</h1>
            <p className="mt-2 text-gray-100">Vui lòng kiểm tra thông tin trước khi thanh toán</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <div 
                  onClick={() => setPaymentInfo(prev => ({ ...prev, paymentMethod: 'vnpay' }))}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Tổng quan đơn hàng</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <div className="flex justify-between text-sm text-gray-600 mt-2">
                    ...
                    <span>{shippingFee > 0 ? `${formatPrice(shippingFee)} VND` : 'Miễn phí'}</span>
                  </div>
